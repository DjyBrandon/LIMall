            ...
            <radio-group class="radio-group">
                <block v-for="(item, index) in addressList" :key="index">
                    <view class="address">
                        ...
                        <view class="select-btn" :data-addrid="item.addrId" @tap="onDefaultAddr">
                            <view class="box">
                                <radio :value="item.prodId" :checked="item.commonAddr == 1" color="#eb2444"
                                    :data-addrid="item.addrId" @tap="onDefaultAddr" />
                                设为默认地址
                            </view>
                        </view>
                    </view>
